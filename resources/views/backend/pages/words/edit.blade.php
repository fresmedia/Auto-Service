...
@section('admin-content')
    ...
    <div class="container-fluid">
        ...
        <div class="create-page">
            <form action="{{ route('admin.words.update', $word->id) }}" method="POST" enctype="multipart/form-data" data-parsley-validate data-parsley-focus="first">
                @csrf
                @method('put')
                <div class="form-body">
                    <div class="card-body">
                        <div class="row ">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="en" name="en" value="{{ $word->en }}" placeholder="Enter Word in English" required=""/>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group has-success">
                                    ...
                                    <select class="form-control custom-select" id="status" name="status" required>
                                        <option value="1" {{ $word->status === 1 ? 'selected' : null }}>Published</option>
                                        <option value="0" {{ $word->status === 0 ? 'selected' : null }}>Draft</option>
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label" for="category_id">Word Category  <i class="fa fa-chevron-right"></i>  Chapter <span
