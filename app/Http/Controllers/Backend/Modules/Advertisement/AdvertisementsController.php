...
class AdvertisementsController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('backend.pages.advertisements.create', compact('languages') );
    }
        ...
        try {
            ...
            if ( isset($request->language_ids) && count( $request->language_ids) > 0 ) {
                foreach ($request->language_ids as $language_id) {
                    $advertisement->languages()->sync($language_id, false);
                }
            }
    ...
    public function edit($id)
    {
        ...
        return view('backend.pages.advertisements.edit', compact('advertisement', 'languages'));
    }
